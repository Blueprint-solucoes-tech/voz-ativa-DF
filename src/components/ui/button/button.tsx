  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-base font-semibold ring-offset-background transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-5 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        outline:
          "border-2 border-input bg-background shadow-sm hover:bg-muted hover:text-foreground active:bg-muted/80",
        secondary:
        ...
        action: "bg-primary text-primary-foreground shadow-lg hover:bg-primary/90 hover:shadow-xl active:bg-primary/95 hover:-translate-y-0.5 active:translate-y-0",
        option: "flex-col h-auto border-2 border-border bg-card text-card-foreground hover:border-primary/50 hover:bg-muted shadow-sm hover:shadow-md",
      },
      size: {
        ...
        icon: "h-12 w-12",
        touch: "min-h-[3rem] px-6 py-4",
        "touch-lg": "min-h-[3.5rem] px-8 py-5 text-lg",
      },
    },
    defaultVariants: {
      variant: "default",
